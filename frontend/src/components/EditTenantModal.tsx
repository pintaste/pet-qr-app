...
import { X, Building2, Loader2, AlertCircle, CheckCircle, User, Key, Plus, Trash2, ToggleLeft, ToggleRight, Eye, EyeOff, RefreshCw } from 'lucide-react'
                        ...
                        <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-600">
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-1 px-3 py-1.5 text-sm bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                            />
                            <button
