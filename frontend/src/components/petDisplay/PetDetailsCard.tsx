/**
 * PetDetailsCard component for displaying pet information and details.
 * Includes pet header, description, and expandable detailed sections.
 */
...
/**
 * Props interface for PetDetailsCard component.
 */
interface PetDetailsCardProps {
  /** Pet information object */
  petInfo: PetInfo
  /** Whether detailed information is expanded */
  showDetailedInfo: boolean
  /** Handler for toggling detailed info visibility */
  onToggleDetailedInfo: () => void
}

/**
 * Card component for displaying pet details with expandable sections.
 *
 * Features:
 * - Pet name, breed, age header
 * - Description display
 ...
 * @returns JSX element for the pet details card
 */
export const PetDetailsCard: React.FC<PetDetailsCardProps> = ({
  petInfo,
  showDetailedInfo,
